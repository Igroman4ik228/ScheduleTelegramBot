...
- Service method prefixes: `get_` for guaranteed single results, `find_` for nullable single results, `list_` for collections, `create_`, `update_`, `delete_` for ORM mutations, and `execute_` for immediate SQL mutations.
