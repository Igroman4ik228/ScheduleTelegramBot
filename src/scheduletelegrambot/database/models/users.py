...
from scheduletelegrambot.database.models.base import (
    BaseModel,
    BoolFalse,
    BoolTrue,
    Int64,
...
from scheduletelegrambot.database.models.mixins.timestamp import TimestampMixin

if TYPE_CHECKING:
    from scheduletelegrambot.database.models import GroupModel, SubscribeModel
...
class UserModel(BaseModel, TimestampMixin):
    ...
    subscribe: Mapped[SubscribeModel | None] = relationship(back_populates="users")
