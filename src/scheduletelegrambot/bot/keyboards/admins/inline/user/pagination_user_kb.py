...
def get_pagination_user_kb(
    total_pages: int, current_page: int, group_id: int | None = None
    ...
    keyboard_builder.button(text=f"{current_page}/{total_pages}", callback_data="None")
    ...
    if current_page < total_pages:
        ...
        keyboard_builder.button(
            text="Вперед ➡️",
            callback_data=PaginationUsersCallbackFactory(current_page=1, group_id=group_id).pack(),
        )
