...
class SubCheckerService(BackgroundService):
    ...
    async def do_work(self):
        ...
        #             user.telegram_id, TimeMessage.ONE.value
        #         )

        #     # Check 5 days before end sub
        #     elif subscribe_end_time - current_time == timedelta(days=5):
        #         await self.sender.safe_send_message(
        #             user.telegram_id, TimeMessage.FIVE.value
        #         )

        #     # Check half time of end sub
        #     elif subscribe_end_time - current_time == timedelta(
        #         days=sub_half_time_span
        #     ):
        #         await self.sender.safe_send_message(
        #             user.telegram_id, TimeMessage.HALF.value
        #         )
        ...
        #         )
        #         await self.sender.safe_send_message(
        #             user.telegram_id, TimeMessage.END.value
        #         )
