...
DEFAULT_TTL = timedelta(minutes=5).seconds
...
# todo: add support cache None value or something like that
def cached(
    ...
    """
    Work only for class methods (with self, not classmethod)
    """
...
# todo: add support delete by pattern
